...
- локальные кэши моделей исключены из Git (см. `.gitignore`).
...
- успешный поиск по базе знаний ![success 1](img/success.png) и ![success 2](img/success2.png)
- отсутствие ответа, если в базе знаний нет информации ![no data](img/failure.png)
